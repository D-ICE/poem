...
PERF_POLARSET_PATH = "/poem/Canopee-perf-polars_20241203_18H05.nc"
...
def download_test_data_from_s3(
    ...
    file_path: str = PERF_POLARSET_PATH,
) -> None:
    try:
        boto3.resource("s3").download_file(bucket_name, file_path, "my_local_image.jpg")
