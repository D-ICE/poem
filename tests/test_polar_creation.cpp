...
int main() {
   ...
   */
  auto var_double = polar_set->New<double, 3>("var_double", "-", "double variable", type::DOUBLE, dimension_point_set);
  auto var_int = polar_set->New<int, 3>("var_int", "-", "int variable", type::DOUBLE, dimension_point_set);
