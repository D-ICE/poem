...
# 1- on fait le ds root avec les attributs qui vont bien
# 2- on crée un groupe PPP et un groupe HPPP



# Mandatory Dataset attribute (R1)
ds.attrs["file_type"] = "poem"
ds.attrs["poem_file_format_version"] = "v1"
...
## Writing a POEM file
ds.to_netcdf('POEM_specs_v1_minimal_example.nc')
