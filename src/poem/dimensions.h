...
namespace poem
{
  ...
  public:
    Dimension(const std::string &name,
              ...
              const std::string &description) : Named(name, unit, description, type::DOUBLE) {} // A dimension has always the type DOUBLE (interpolation coord)
  };
  ...
  {
  public:
    explicit DimensionSet(const std::array<std::shared_ptr<Dimension>, _dim> &dimension_array) : m_dimension_array(dimension_array)
    {
  ...
  public:
    DimensionPoint(const DimensionSet<_dim> *dimension_set,
                   const std::array<double, _dim> &array) : m_dimension_set(dimension_set),
                                                            m_array(array) {}
  ...
  {
  public:
    explicit DimensionGrid(std::shared_ptr<DimensionSet<_dim>> dimension_set) : m_dimension_set(dimension_set) {}
  ...
  {
  public:
    explicit DimensionPointSet(const DimensionGrid<_dim> &dimension_grid) : m_dimension_points(dimension_grid.dimension_points()),
