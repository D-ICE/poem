...
namespace poem {
  ...
  void PolarSetReader::Read(const std::string &nc_polar) {
  ...
  std::shared_ptr<PolarSet> PolarSetReader::polar_set() const { return m_polar_set; }

  std::shared_ptr<Attributes> PolarSetReader::attributes() const { return m_attributes; }

  void PolarSetReader::load_attributes() {
  ...
  void PolarSetReader::load_dimensions() {
  ...
  void PolarSetReader::load_polars() {
