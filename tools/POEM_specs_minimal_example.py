...
__POEM_VERSION__ = "0.4"
__POEM_SPECS_VERSION__ = "0.1"
...
# POEM Specifications rules numbers are specified next to the different instructions of the following code
...
## Writing a POEM file
ds.to_netcdf('POEM_specs_minimal_example.nc')
